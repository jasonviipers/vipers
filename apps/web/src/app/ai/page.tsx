...
import { Bubble, BubbleContent } from "@viipers/ui/components/bubble";
import { Button } from "@viipers/ui/components/button";
import {
  Empty,
  EmptyDescription,
  EmptyHeader,
  EmptyMedia,
  EmptyTitle,
} from "@viipers/ui/components/empty";
import {
  InputGroup,
  InputGroupAddon,
  InputGroupButton,
  InputGroupTextarea,
} from "@viipers/ui/components/input-group";
import {
  Message,
  MessageContent as MessageBody,
  MessageHeader,
} from "@viipers/ui/components/message";
import {
  MessageScroller,
...
} from "@viipers/ui/components/message-scroller";
import { Tooltip, TooltipContent, TooltipTrigger } from "@viipers/ui/components/tooltip";
          ...
          {messages.length === 0 && !isSending ? (
            <Empty className="mx-auto h-full max-w-3xl px-4">
              <EmptyHeader>
                ...
                <EmptyTitle>Morning, viipers!</EmptyTitle>
